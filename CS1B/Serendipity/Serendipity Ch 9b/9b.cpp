...
// Date of Last Modification: 4/02/18                                         -
// ----------------------------------------------------------------------------
// Purpose: Serendipity                                                       -
// ----------------------------------------------------------------------------
// Algorithm:                                                                 -
			 ...
			 BookData book[])
{
	...
	do
	{
		...
		{
		case '1': repListing(bookCount, book);
				break;
				...
				BookData book[])
{
	...
	cout << right
		 << setw(34) << "REPORT LISTING"
		 << endl;
		 
	cout << "DATE: " << dateAndTime;
	cout << "PAGE: " << pgNum      << " of " << totalPgs;
	cout << "     ";
	...
	{
		cout <<             book[count].bookTitle.substr(0, 24);
		cout << setw(11) << book[count].isbn;
		cout << setw(16) << book[count].author;
		cout << setw(16) << book[count].publisher;
		cout << setw(11) << book[count].dateAdded;
		cout << setw(8)  << book[count].qtyOnHand;
		cout << setw(15) << book[count].wholesale;
		cout << setw(13) << book[count].retail;
		cout << endl;
	}
			 ...
			 BookData book[])
{
	...
	do
	{
		...
		subtotalC = book[bookCount].qtyOnHand * book[bookCount].retail;
		taxC      = subtotalC * 0.06;
