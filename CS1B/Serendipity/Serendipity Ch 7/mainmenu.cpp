...
// Date of Last Modification: 1/25/18                                         -
// ----------------------------------------------------------------------------
// Purpose: Serendipity                                                       -
// ----------------------------------------------------------------------------
// Algorithm:                                                                 -
...
int main()
{
	...
	//ARRAYS
	string bookTitle[NUM_OF_BOOKS];
	string isbn[NUM_OF_BOOKS];
	string author[NUM_OF_BOOKS];
	string publisher[NUM_OF_BOOKS];
	string dateAdded[NUM_OF_BOOKS];
	int    qtyOnHand[NUM_OF_BOOKS];
	double wholesale[NUM_OF_BOOKS];
	double retail[NUM_OF_BOOKS];
